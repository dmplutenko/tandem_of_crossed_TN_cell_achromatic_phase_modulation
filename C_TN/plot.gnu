...
plot "results.txt" using 1:2 title "Exact Numerical" w l ls 1, \
     "results.txt" using 1:3 title "1st Order Approx." w l ls 3, \
     "results.txt" using 1:4 title "2nd Order Approx." w l ls 2, \
     "results.txt" using 1:5 title "FoM Bound ($\\mathcal{A}^{\\left(0\\right)}$)" w l ls 4
