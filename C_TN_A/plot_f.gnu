...
set key at screen 0.55, 0.93 center top horizontal box opaque width 2 height 1 spacing 1 samplen 4
...
plot "results.txt" using 1:4 title "Exact Numerical" w l ls 11, \
     "results.txt" using 1:5 title "FoM Envelope ($\\pm\\pi\\mathcal{P}_1^{\\left(\\text{A}\\right)}$)" w l ls 2, \
     "results.txt" using 1:(-$5) notitle w l ls 2
