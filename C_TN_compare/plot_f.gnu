...
#set key at screen 0.55, 0.93 center top horizontal box opaque width 4 height 1 spacing 1 samplen 5
set key top right horizontal box opaque width 4 height 1 spacing 1 samplen 5
...
plot "results.txt" using 1:5 title "Uncompensated (Baseline)" w l ls 1, \
     "results.txt" using 1:6 title "Strategy A (Active)" w l ls 3, \
     "results.txt" using 1:7 title "Strategy B (Passive)" w l ls 2
